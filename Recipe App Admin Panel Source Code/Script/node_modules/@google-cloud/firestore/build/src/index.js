...
class Firestore {
    ...
    newTraceUtilInstance(settings) {
        ...
        let createEnabledInstance = (_a = settings.openTelemetryOptions) === null || _a === void 0 ? void 0 : _a.enableTracing;
        ...
        if (createEnabledInstance) {
            ...
            if (this._traceUtil && this._traceUtil instanceof enabled_trace_util_1.EnabledTraceUtil) {
