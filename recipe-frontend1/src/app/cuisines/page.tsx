...
const CuisinesPage = () => {
  ...
  return (
    <PageTemplate
      title="Cuisines"
      breadcrumbs={[{ label: 'Cuisines' }]}
      addButtonText="Add Cuisine"
      addButtonHref="/cuisines/add"
    >
      <div className="card">
              ...
              <table className="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
                  <tr className="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th className="min-w-125px">Cuisine</th>
                      ...
                      <td className="text-end">
                        ...
                        <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4">
                          <div className="menu-item px-3">
                            <a 
                              href={`/cuisines/edit/${cuisine._id}`} 
