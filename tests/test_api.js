...
async function testAPI() {
    try {
        ...
        const healthResponse = await axios.post('http://localhost:3000/api/getAllIntro', {});
        ...
        try {
            const loginResponse = await axios.post('http://localhost:3000/api/SignIn', loginData);
            ...
            const userResponse = await axios.post('http://localhost:3000/api/GetUser', {}, {
                headers: {
