...
import 'shimmer_row_container_component_model.dart';
export 'shimmer_row_container_component_model.dart';

class ShimmerRowContainerComponentWidget extends StatefulWidget {
  const ShimmerRowContainerComponentWidget({super.key});

  @override
  State<ShimmerRowContainerComponentWidget> createState() =>
      _ShimmerRowContainerComponentWidgetState();
}

class _ShimmerRowContainerComponentWidgetState
    extends State<ShimmerRowContainerComponentWidget>
    with TickerProviderStateMixin {
  late ShimmerRowContainerComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShimmerRowContainerComponentModel());
