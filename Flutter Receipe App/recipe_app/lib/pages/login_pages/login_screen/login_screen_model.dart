...
class LoginScreenModel extends FlutterFlowModel<LoginScreenWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetAllFavouriteRecipesApi)] action in Button widget.
  ApiCallResponse? getFavourite;
  // Stores action output result for [Backend Call - API (DeleteFavouriteRecipeApi)] action in Button widget.
  ApiCallResponse? removeFavouriteFunction;
  // Stores action output result for [Backend Call - API (AddFavouriteRecipe)] action in Button widget.
