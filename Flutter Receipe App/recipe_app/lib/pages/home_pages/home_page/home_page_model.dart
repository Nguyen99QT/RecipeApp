...
class HomePageModel extends FlutterFlowModel<HomePageWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetUserApi)] action in HomePage widget.
  ApiCallResponse? getUser;
  // Stores action output result for [Backend Call - API (isVerifyAccountApi)] action in HomePage widget.
