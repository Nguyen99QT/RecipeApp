...
import 'popularrecipe_screen_model.dart';
export 'popularrecipe_screen_model.dart';

class PopularrecipeScreenWidget extends StatefulWidget {
  const PopularrecipeScreenWidget({super.key});

  @override
  State<PopularrecipeScreenWidget> createState() =>
      _PopularrecipeScreenWidgetState();
}

class _PopularrecipeScreenWidgetState extends State<PopularrecipeScreenWidget> {
  late PopularrecipeScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopularrecipeScreenModel());
                                    ...
                                    if (FFAppState().filterVariable == false) {
                                      return FutureBuilder<ApiCallResponse>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final containerPopularRecipeApiResponse =
                                              snapshot.data!;
                                            ...
                                            child: Builder(
                                              builder: (context) {
                                                if (RecipeAppGroup
                                                            .popularRecipeApiCall
                                                            .receipeList(
                                                          containerPopularRecipeApiResponse
                                                              .jsonBody,
                                                        ) !=
                                                        null &&
                                                    (RecipeAppGroup
                                                            ...
                                                            builder: (context) {
                                                              final popularList =
                                                                  RecipeAppGroup
                                                                          .popularRecipeApiCall
                                                                          .receipeList(
                                                                            containerPopularRecipeApiResponse.jsonBody,
                                                                          )
                                                                          ?.toList() ??
                                                                      [];
                                                              ...
                                                              return Wrap(
                                                                ...
                                                                children: List.generate(
                                                                  ...
                                                                  return MainContainerWidget(
                                                                    key: Key(
                                                                        'Keydqh_${popularListIndex}_of_${popularList.length}'),
                                                                    image:
                                                            ...
                                                            builder: (context) {
                                                              ...
                                                              return Wrap(
                                                                ...
                                                                children: List.generate(
                                                                  ...
                                                                  return MainContainerWidget(
                                                                    key: Key(
                                                                        'Key51w_${filterRecipeListIndex}_of_${filterRecipeList.length}'),
                                                                    image:
                                                                        '${FFAppConstants.imageUrl}${getJsonField(
